...
export const tutorialVictim = {
  ...
  background:
    "재벌 그룹의 은퇴한 회장. 최근 유산 분배 문제로 가족들과 갈등이 있었다.",
};
...
export const tutorialEvidence = [
  {
    ...
    assistantComment:
      "저기 칼날 끝에 누군가의 지문이 묻어있는 것 같아요! 급하게 닦았지만 미세한 혈흔이 남아있네요.",
  ...
  },
  {
    ...
    assistantComment:
      "열쇠에 숫자 3이 새겨져 있어요! 저택 어딘가에 3번 금고가 있을 것 같은데요.",
...
export const tutorialRooms = [
  {
    ...
    name: "1층 - 침실",
    description:
      "피해자가 마지막으로 잠들었던 침실입니다. 침대 시트에 핏자국이 남아있습니다.",
    assistantComment:
      "방 안이 어수선해요... 누군가 급하게 물건을 뒤진 흔적이 보여요.",
    unlocked: true,
  },
  {
    id: 2,
    ...
    name: "2층 - 서재",
    description:
      "피해자의 개인 서재입니다. 중요한 문서들이 보관되어 있었습니다.",
    assistantComment:
      "서류들이 바닥에 흩어져 있어요. 누가 뭔가를 찾고 있었던 것 같아요.",
    unlocked: true,
  },
  {
    id: 3,
...
export const watsonDialogs = {
  ...
  evidenceListIntro: {
    ...
    avatar: "🧑‍💼",
    messages: [
      "이렇게 수사 팔레트 목록에서 마우스를 올리거나 클릭하면 상세 정보를 볼 수 있어요!",
