...
public class AuthService {
     ...
     * 토큰 갱신 결과 코드
     * <ul>
     *   <li>{@link #SUCCESS}: Refresh Token 기반 갱신 성공</li>
     *   <li>{@link #UNAUTHORIZED}: 세션 미인증 또는 갱신 실패로 재로그인 필요</li>
     * </ul>
     */
     ...
     * </p>
     *
     * @param oidcUser 현재 인증된 OIDC 사용자
     * @return 인증 주체 기반의 {@link AuthMeResponse}
     * @throws BaseException 인증 주체가 없거나 로그인 정보가 유효하지 않은 경우
     */
