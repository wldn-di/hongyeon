...
public enum ErrorCode {
    ...
    SESSION_ALREADY_COMPLETED(HttpStatus.CONFLICT, "SESSION_003", "이미 완료한 시나리오입니다. 수사보고서만 열람 가능합니다."),
    ...
    VICTIM_NOT_FOUND(HttpStatus.NOT_FOUND, "VICTIM_001", "피해자를 찾을 수 없습니다."),
